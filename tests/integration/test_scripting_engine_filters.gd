...
class TestFilterGtGeLtLe:
	...
	func test_property_filter_gt_ge_lt_le():
		await table_move(cards[1], Vector2(300, 300))
		await table_move(cards[2], Vector2(750, 300))
		await table_move(cards[3], Vector2(1050, 300))
...
class TestTokensFilterGtGeLtLe:
	...
	func test_tokens_filter_gt_ge_lt_le():
		...
		await table_move(cards[2], Vector2(750, 300))
		await table_move(cards[3], Vector2(1050, 300))
		await table_move(cards[4], Vector2(1350, 300))
...
class TestAnd:
	...
	func test_and():
		...
		await table_move(cards[0], Vector2(750, 300))
		await table_move(cards[4], Vector2(1200, 300))
